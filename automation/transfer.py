...
from automation.models import RoutineDefinition
from automation.routines import RoutineStore
from automation.tasks import TaskRegistry
from automation.core_triggers import CORE_TRIGGER_TYPES, CoreTriggerStore
from obs_service.triggers import OBS_TRIGGER_TYPES, ObsTriggerStore
...
def validate_import(
    ...
    *,
    ...
    if payload.get("format") != FORMAT or int(payload.get("version", 0)) != VERSION:
        raise ValueError("This is not a supported Sally routine file.")
