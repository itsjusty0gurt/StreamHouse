...
def save_discovery() -> None:
    ...
    draw_text(painter, QRectF(106, 31, 178, 34), "STREAMHOUSE", 17, bold=True)
...
def save_screenshot() -> None:
    ...
    draw_text(
        painter,
        QRectF(176, 54, 760, 48),
        "Streamhouse Soundboard",
        32,
        bold=True,
    )
    draw_text(
        ...
        "Viewer-powered sounds, routed through Streamhouse Hub automation",
        16,
        color=MUTED,
    )
    ...
    draw_text(
        ...
        "Broadcasters configure every sound and action in Streamhouse Hub.",
        13,
        color=MUTED,
        alignment=Qt.AlignCenter,
    )
