...
class ChannelPointsPage(QWidget):
    ...
    def _rewards_loaded(self, result: object) -> None:
        ...
        self.status_label.setText(
            ...
            "Rewards made outside Streamhouse Hub are shown read-only."
        )
    ...
    def _populate(self, selected_id: str = "") -> None:
        ...
        for row, reward in enumerate(self.rewards):
            ...
            values = (
                ...
                "Streamhouse Hub" if reward.manageable else "Other app",
            )
        ...
        if isinstance(error, HTTPError):
            ...
            if error.code == 403:
                return (
                    ...
                    "Affiliate or Partner channel, and only Streamhouse Hub-created "
