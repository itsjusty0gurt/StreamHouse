...
class CompanionSettings:
    ...
    @classmethod
    def from_dict(cls, values: dict[str, Any]) -> CompanionSettings:
        defaults = cls()
...
class CompanionSettingsStore:
    ...
    def load(self) -> CompanionSettings:
        ...
        if not isinstance(payload, dict):
            raise ValueError("Companion settings must contain an object.")
        return CompanionSettings.from_dict(payload)
